...
void gimbal_center_adjust(gimbal_t p_gimbal)
{
    ...
    /* yaw */
    {
        ...
        else
        {
            ...
            {
                center_param.yaw_ecd_center =  2670;//(yaw_ecd_l + yaw_ecd_r) / 2 - 4096;//HERO-RM
            }
            else
            {
                center_param.yaw_ecd_center =  2670;//(yaw_ecd_l + yaw_ecd_r) / 2 + 4096;
            }
        }
    }
